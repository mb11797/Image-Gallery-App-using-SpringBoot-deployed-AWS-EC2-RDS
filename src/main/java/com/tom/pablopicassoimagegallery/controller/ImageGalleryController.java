package com.tom.pablopicassoimagegallery.controller;
...
public class ImageGalleryController {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(ImageGalleryController.class);
    ...
    public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name, @RequestParam("price") Double price, @RequestParam("description") String description, Model model, HttpServletRequest request, final @RequestParam("image") MultipartFile file){
        try{
    ...
    @ResponseBody
    void showImage(@PathVariable("id") Long id, HttpServletResponse response, Optional<ImageGallery> imageGallery) throws ServletException, IOException {
        LOGGER.info("Id: " + id);
    ...
    String showProductDetails(@RequestParam("id") Long id, Optional<ImageGallery> imageGallery, Model model){
        try{
            ...
            if(id != 0){
                ...
                LOGGER.info("Products: " + imageGallery);
